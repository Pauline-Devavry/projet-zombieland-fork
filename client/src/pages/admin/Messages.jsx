                    ...
                    <div className="flex bg-adminSideBarColor border border-adminBorderColor rounded p-2 gap-2 flex-1">
                        <div className="flex gap-4 ">
                            ...
                            <p className="whitespace-nowrap overflow-hidden text-ellipsis max-w-[400px]">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio voluptatum consectetur recusandae magni optio! Nulla veritatis quia culpa ullam deserunt harum mollitia unde reprehenderit consectetur?.
                            </p>
                        </div>
                    </div>
