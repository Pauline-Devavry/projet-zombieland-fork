  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        setUser(response.data.user); // Supposons que l'API renvoie les données de l'utilisateur
        setSuccess("Enregistrement réussi !");
        toast("Enregistrement réussi !", { theme: "dark", type: "success" });
    ...
    <div className="min-h-screen max-w-[75rem] mx-auto flex flex-col justify-center items-center text-white font-rubik">
      <div className="w-full">
        <h2 className="text-lg mb-6">
          Vous souhaitez vous inscrire dans un parc d’attraction incroyablement
          terrifiant, vous aimez les sensations fortes ? Vous trouverez sur
          cette page ce que vous êtes venus chercher, notre{" "}
        ...
        <form
          ...
          className="max-w-[400px] mx-auto p-8 rounded-lg shadow-lg"
        >
