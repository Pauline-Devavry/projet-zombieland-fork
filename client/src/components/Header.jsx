...
function Header() {
  ...
  return (
    <header className="w-full relative">
      <div
        className={`bg-backgroundColor w-full fixed p-6 z-50   shadow-xl border-b transform transition-transform duration-300 ease-in-out ${
        ...
        <nav>
          ...
          >
            <img
              src={closeBurger}
              className="h-6"
              alt="Bouton pour fermer le menu de navigation"
            />
          </a>
        </nav>
      </div>
        ...
        <nav>
          ...
          <a href="" onClick={handleBurgerMenu}>
            <img
              ...
              alt="Bouton pour ouvrir le menu de navigation."
            />
          </a>
        </nav>
      </div>
